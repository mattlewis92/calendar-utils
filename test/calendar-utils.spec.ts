...
adapters.forEach(({ name, adapter: dateAdapter }) => {
  describe(`Adapter: ${name}`, () => {
    ...
    describe('getDayView', () => {
      ...
      it('should provide a minimum event height', () => {
        const events: CalendarEvent[] = [
          {
            start: moment()
              .startOf('day')
        ...
        expect(result.events[0].height).toEqual(60);
      });

      it('should provide a minimum event height for events with no end', () => {
        const events: CalendarEvent[] = [
          {
            start: moment()
              .startOf('day')
      ...
      it('should not overflow the view when the min event height is outside of it', () => {
        const events: CalendarEvent[] = [
          {
            start: moment()
              .startOf('day')
        ...
        expect(result.events[0].height).toEqual(29);
      });
    });
